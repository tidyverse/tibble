...
same features as
[`tibble()`](https://tibble.tidyverse.org/reference/tibble.md). `lst()`
builds components sequentially. When defining a component, you can refer
to components created earlier in the call. `lst()` also generates
missing names automatically.
