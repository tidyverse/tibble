...
[`tbl_df`](https://tibble.tidyverse.org/reference/tbl_df-class.md). This
is in contrast with
[`tibble()`](https://tibble.tidyverse.org/reference/tibble.md), which
builds a tibble from individual columns. `as_tibble()` is to
[`tibble()`](https://tibble.tidyverse.org/reference/tibble.md) as
