...
- [`new_tibble()`](https://tibble.tidyverse.org/reference/new_tibble.md)
  and
...
- Rework [`view()`](https://tibble.tidyverse.org/reference/view.md) to
  better work with RStudio and Positron
...
- Document that `...` must be empty in
  [`print.tbl_df()`](https://tibble.tidyverse.org/reference/formatting.md).
...
- [`as_data_frame()`](https://tibble.tidyverse.org/reference/deprecated.md)
  now also refers to
...
- Deprecated functions and arguments where we could not detect usage by
  ...
  - [`data_frame_()`](https://tibble.tidyverse.org/reference/deprecated.md),
    [`lst_()`](https://tibble.tidyverse.org/reference/deprecated.md),
    [`frame_data()`](https://tibble.tidyverse.org/reference/deprecated.md)

  - `as_tibble(validate = )`, `as_tibble(NULL)`,
    `new_tibble(subclass = )`

  - [`add_row()`](https://tibble.tidyverse.org/reference/add_row.md) and
...
- Forward
  [`trunc_mat()`](https://tibble.tidyverse.org/reference/trunc_mat.md)
...
- New
  [`vignette("extending")`](https://tibble.tidyverse.org/articles/extending.md)
...
- Fix display of mermaid diagrams in
  [`vignette("formats")`](https://tibble.tidyverse.org/articles/formats.md)
...
- [`set_num_opts()`](https://tibble.tidyverse.org/reference/num.md) and
  [`set_char_opts()`](https://tibble.tidyverse.org/reference/char.md)
  are reexported from pillar
  ([\#959](https://github.com/tidyverse/tibble/issues/959)).
- [`view()`](https://tibble.tidyverse.org/reference/view.md) uses
...
- Move
  ...
  [`vignette("numbers")`](https://tibble.tidyverse.org/articles/numbers.md),
  [`?num`](https://tibble.tidyverse.org/reference/num.md) and
  [`?char`](https://tibble.tidyverse.org/reference/char.md) from the
  pillar package here
...
- New
  [`?tibble_options`](https://tibble.tidyverse.org/reference/tibble_options.md)
...
- [`as_tibble_row()`](https://tibble.tidyverse.org/reference/as_tibble.md)
  supports arbitrary vectors
  ([\#797](https://github.com/tidyverse/tibble/issues/797)).
- [`enframe()`](https://tibble.tidyverse.org/reference/enframe.md) and
  [`deframe()`](https://tibble.tidyverse.org/reference/enframe.md)
...
- [`tibble()`](https://tibble.tidyverse.org/reference/tibble.md) and
  [`tibble_row()`](https://tibble.tidyverse.org/reference/tibble.md)
...
- [`num()`](https://tibble.tidyverse.org/reference/num.md) and
  [`char()`](https://tibble.tidyverse.org/reference/char.md) are
  reexported from pillar
  ([\#880](https://github.com/tidyverse/tibble/issues/880)).
- [`tribble()`](https://tibble.tidyverse.org/reference/tribble.md) and
  [`frame_matrix()`](https://tibble.tidyverse.org/reference/frame_matrix.md)
...
- [`has_rownames()`](https://tibble.tidyverse.org/reference/rownames.md)
...
- [`as_tibble.table()`](https://tibble.tidyverse.org/reference/as_tibble.md)
...
- Register
  [`format.tbl()`](https://tibble.tidyverse.org/reference/formatting.md)
  and
...
- [`tribble()`](https://tibble.tidyverse.org/reference/tribble.md) now
  better handles named inputs
...
- Remove superseded signal for
  [`as_tibble.list()`](https://tibble.tidyverse.org/reference/as_tibble.md),
  because
  [`as_tibble_row()`](https://tibble.tidyverse.org/reference/as_tibble.md)
...
- [`tibble()`](https://tibble.tidyverse.org/reference/tibble.md) now
...
- [`tribble()`](https://tibble.tidyverse.org/reference/tribble.md) is
  now stricter when combining values. All values in a column must be
...
- [`add_row()`](https://tibble.tidyverse.org/reference/add_row.md) now
  uses
...
- New [`tibble_row()`](https://tibble.tidyverse.org/reference/tibble.md)
...
- New
  [`as_tibble_row()`](https://tibble.tidyverse.org/reference/as_tibble.md)
  and
  [`as_tibble_col()`](https://tibble.tidyverse.org/reference/as_tibble.md)
...
- [`as_tibble.data.frame()`](https://tibble.tidyverse.org/reference/as_tibble.md)
...
- [`tribble()`](https://tibble.tidyverse.org/reference/tribble.md) now
  returns columns with `"unspecified"` type for 0-row tibbles.
...
- [`tibble()`](https://tibble.tidyverse.org/reference/tibble.md) ignores
  NULL arguments, named or unnamed
  ([\#580](https://github.com/tidyverse/tibble/issues/580)).

- [`view()`](https://tibble.tidyverse.org/reference/view.md) works for
  remote data sources by applying the same strategy as
...
- [`view()`](https://tibble.tidyverse.org/reference/view.md) now uses
  the created (or passed) title argument
...
- [`add_row()`](https://tibble.tidyverse.org/reference/add_row.md),
  [`add_case()`](https://tibble.tidyverse.org/reference/add_row.md) and
  [`add_column()`](https://tibble.tidyverse.org/reference/add_column.md)
  now signal a warning once per session if the input is not a data frame
  ([\#575](https://github.com/tidyverse/tibble/issues/575)).

- Fix [`view()`](https://tibble.tidyverse.org/reference/view.md) for the
  case when an object named `x` exists in the global environment
...
The [`tibble()`](https://tibble.tidyverse.org/reference/tibble.md) and
[`as_tibble()`](https://tibble.tidyverse.org/reference/as_tibble.md)
...
- [`new_tibble()`](https://tibble.tidyverse.org/reference/new_tibble.md)
  ...
  [`validate_tibble()`](https://tibble.tidyverse.org/reference/new_tibble.md)
...
- Calling
  ...
  [`enframe()`](https://tibble.tidyverse.org/reference/enframe.md) for
  converting a named vector to a two-column tibble.

- [`data_frame()`](https://tibble.tidyverse.org/reference/deprecated.md)
  and
  [`frame_data()`](https://tibble.tidyverse.org/reference/deprecated.md)
  are soft-deprecated, please use
  [`tibble()`](https://tibble.tidyverse.org/reference/tibble.md) or
  [`tribble()`](https://tibble.tidyverse.org/reference/tribble.md)
  ([\#111](https://github.com/tidyverse/tibble/issues/111)).

- [`tibble_()`](https://tibble.tidyverse.org/reference/deprecated.md),
  [`data_frame_()`](https://tibble.tidyverse.org/reference/deprecated.md),
  and [`lst_()`](https://tibble.tidyverse.org/reference/deprecated.md)
  are soft-deprecated. Please use
  [`tibble()`](https://tibble.tidyverse.org/reference/tibble.md) or
  [`lst()`](https://tibble.tidyverse.org/reference/lst.md)
  ([\#111](https://github.com/tidyverse/tibble/issues/111),
  [\#509](https://github.com/tidyverse/tibble/issues/509)).

- [`as.tibble()`](https://tibble.tidyverse.org/reference/deprecated.md)
  and
  [`as_data_frame()`](https://tibble.tidyverse.org/reference/deprecated.md)
...
- [`as_tibble.data.frame()`](https://tibble.tidyverse.org/reference/as_tibble.md)
  (and also
  [`as_tibble.matrix()`](https://tibble.tidyverse.org/reference/as_tibble.md))
...
- [`column_to_rownames()`](https://tibble.tidyverse.org/reference/rownames.md)
...
- [`enframe()`](https://tibble.tidyverse.org/reference/enframe.md) (with
  `name = NULL`) and
  [`deframe()`](https://tibble.tidyverse.org/reference/enframe.md) now
  support one-column tibbles
...
- Added experimental
  [`view()`](https://tibble.tidyverse.org/reference/view.md) function
  that always returns its input invisibly and calls
...
- The
  [`set_tidy_names()`](https://tibble.tidyverse.org/reference/name-repair-superseded.md)
  and
  [`tidy_names()`](https://tibble.tidyverse.org/reference/name-repair-superseded.md)
...
- [`tibble()`](https://tibble.tidyverse.org/reference/tibble.md) uses
  recycled values during construction but unrecycled values for
  validation.

- [`tibble()`](https://tibble.tidyverse.org/reference/tibble.md) is now
  faster for very wide tibbles.
...
- Make [`add_case()`](https://tibble.tidyverse.org/reference/add_row.md)
  an alias for
  [`add_row()`](https://tibble.tidyverse.org/reference/add_row.md)
...
- [`` `[.tbl_df`() ``](https://tibble.tidyverse.org/reference/subsetting.md)
...
- Values of length 1 in a
  [`tibble()`](https://tibble.tidyverse.org/reference/tibble.md) call
  are recycled prior to evaluating subsequent arguments, improving
  consistency with
  [`mutate()`](https://dplyr.tidyverse.org/reference/mutate.html)
  ([\#213](https://github.com/tidyverse/tibble/issues/213)).
- Recycling of values of length 1 in a
  [`tibble()`](https://tibble.tidyverse.org/reference/tibble.md) call
  maintains their class
  ([\#284](https://github.com/tidyverse/tibble/issues/284)).
- [`add_row()`](https://tibble.tidyverse.org/reference/add_row.md) now
  always preserves the column data types of the input data frame the
  same way as [`rbind()`](https://rdrr.io/r/base/cbind.html) does
  ([\#296](https://github.com/tidyverse/tibble/issues/296)).
- [`lst()`](https://tibble.tidyverse.org/reference/lst.md) now again
...
- [`tibble()`](https://tibble.tidyverse.org/reference/tibble.md) gives a
  consistent error message in the case of duplicate column names
...
- New
  ...
  [`repair_names()`](https://tibble.tidyverse.org/reference/name-repair-superseded.md)
  which works unchanged for now
  ([\#217](https://github.com/tidyverse/tibble/issues/217)).
- New
  [`rowid_to_column()`](https://tibble.tidyverse.org/reference/rownames.md)
...
- Own printing routine, not relying on
  ...
  [`format.tbl_df()`](https://tibble.tidyverse.org/reference/formatting.md)
...
- [`tribble()`](https://tibble.tidyverse.org/reference/tribble.md) now
  handles values that have a class
...
- New
  ...
  [@LaDilettante](https://github.com/LaDilettante)).
- New [`deframe()`](https://tibble.tidyverse.org/reference/enframe.md)
  as reverse operation to
  [`enframe()`](https://tibble.tidyverse.org/reference/enframe.md)
...
- An attempt to call
  [`add_row()`](https://tibble.tidyverse.org/reference/add_row.md) for a
  grouped data frame results in a helpful error message
...
- [`add_row()`](https://tibble.tidyverse.org/reference/add_row.md) now
  correctly handles existing columns of type `list` that are not updated
  ([\#148](https://github.com/tidyverse/tibble/issues/148)).
...
- Rename
  [`frame_data()`](https://tibble.tidyverse.org/reference/deprecated.md)
  to [`tribble()`](https://tibble.tidyverse.org/reference/tribble.md),
...
- [`add_row()`](https://tibble.tidyverse.org/reference/add_row.md) now
  can add multiple rows, with recycling
...
- [`tibble()`](https://tibble.tidyverse.org/reference/tibble.md) is no
  longer an alias for
  [`frame_data()`](https://tibble.tidyverse.org/reference/deprecated.md)
...
- Prefer [`tibble()`](https://tibble.tidyverse.org/reference/tibble.md)
  and
  [`as_tibble()`](https://tibble.tidyverse.org/reference/as_tibble.md)
  over
  [`data_frame()`](https://tibble.tidyverse.org/reference/deprecated.md)
  ...
  ([\#82](https://github.com/tidyverse/tibble/issues/82)).
- New
  [`is.tibble()`](https://tibble.tidyverse.org/reference/is.tibble.md)
  and
  [`is_tibble()`](https://tibble.tidyverse.org/reference/is_tibble.md)
  ([\#79](https://github.com/tidyverse/tibble/issues/79)).
- New [`enframe()`](https://tibble.tidyverse.org/reference/enframe.md)
...
- Implement
  [`as_tibble.default()`](https://tibble.tidyverse.org/reference/as_tibble.md)
...
- Exported functions:
  ...
  - New [`lst()`](https://tibble.tidyverse.org/reference/lst.md) and
    [`lst_()`](https://tibble.tidyverse.org/reference/deprecated.md)
  ...
  - New [`add_row()`](https://tibble.tidyverse.org/reference/add_row.md)
    makes it easy to add a new row to data frame (hadley/dplyr#1021).
  - New
    [`rownames_to_column()`](https://tibble.tidyverse.org/reference/rownames.md)
    and
    [`column_to_rownames()`](https://tibble.tidyverse.org/reference/rownames.md)
  ...
  - New
    [`has_rownames()`](https://tibble.tidyverse.org/reference/rownames.md)
    and
    [`remove_rownames()`](https://tibble.tidyverse.org/reference/rownames.md)
...
- Features
  ...
  - Non-scalar input to
    [`frame_data()`](https://tibble.tidyverse.org/reference/deprecated.md)
    and [`tibble()`](https://tibble.tidyverse.org/reference/tibble.md)
