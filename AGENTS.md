...
- Use explicit package prefixes (e.g., `withr::local_options()`) for clarity
...
- An ellipsis guarded with `rlang::check_dots_empty()` or similar separating mandatory and optional arguments when appropriate
