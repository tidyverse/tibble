...
* Version: 1.3.0
* GitHub: https://github.com/MAnalytics/akmedoids
* Source code: https://github.com/cran/akmedoids
* Date/Publication: 2021-04-13 04:50:02 UTC
* Number of recursive dependencies: 118

Run `revdepcheck::cloud_details(, "akmedoids")` for more info

</details>

## In both

*   checking whether package ‘akmedoids’ can be installed ... ERROR
    ```
    Installation failed.
    See ‘/tmp/workdir/akmedoids/new/akmedoids.Rcheck/00install.out’ for details.
    ```
...
```
* installing *source* package ‘akmedoids’ ...
** package ‘akmedoids’ successfully unpacked and MD5 sums checked
...
Execution halted
ERROR: lazy loading failed for package ‘akmedoids’
* removing ‘/tmp/workdir/akmedoids/new/akmedoids.Rcheck/akmedoids’
...
Execution halted
ERROR: lazy loading failed for package ‘akmedoids’
* removing ‘/tmp/workdir/akmedoids/old/akmedoids.Rcheck/akmedoids’
...
```
* using log directory ‘/tmp/workdir/GOxploreR/new/GOxploreR.Rcheck’
* using R version 4.1.1 (2021-08-10)
* using platform: x86_64-pc-linux-gnu (64-bit)
* using session charset: UTF-8
* using option ‘--no-manual’
* checking for file ‘GOxploreR/DESCRIPTION’ ... OK
* checking extension type ... Package
* this is package ‘GOxploreR’ version ‘1.2.6’
* package encoding: UTF-8
* checking package namespace information ... OK
* checking package dependencies ... ERROR
...
```
* using log directory ‘/tmp/workdir/GOxploreR/old/GOxploreR.Rcheck’
* using R version 4.1.1 (2021-08-10)
* using platform: x86_64-pc-linux-gnu (64-bit)
* using session charset: UTF-8
* using option ‘--no-manual’
...
*   checking whether package ‘itsdm’ can be installed ... ERROR
    ```
    Installation failed.
    See ‘/tmp/workdir/itsdm/new/itsdm.Rcheck/00install.out’ for details.
    ```
...
```
* installing *source* package ‘itsdm’ ...
** package ‘itsdm’ successfully unpacked and MD5 sums checked
** using staged installation
** R
** data
*** moving datasets to lazyload DB
...
Calls: <Anonymous> ... loadNamespace -> withRestarts -> withOneRestart -> doWithOneRestart
Execution halted
ERROR: lazy loading failed for package ‘itsdm’
* removing ‘/tmp/workdir/itsdm/new/itsdm.Rcheck/itsdm’
...
Execution halted
ERROR: lazy loading failed for package ‘itsdm’
* removing ‘/tmp/workdir/itsdm/old/itsdm.Rcheck/itsdm’
...
* Date/Publication: 2023-02-10 18:20:06 UTC
...
* checking extension type ... Package
* this is package ‘RBesT’ version ‘1.6-5’
* package encoding: UTF-8
* checking package namespace information ... OK
* checking package dependencies ... ERROR
