...
* Version: 0.9.0
* GitHub: NA
* Source code: https://github.com/cran/dataversionr
* Date/Publication: 2022-08-18 08:40:05 UTC
* Number of recursive dependencies: 60

Run `revdepcheck::cloud_details(, "dataversionr")` for more info

</details>

## In both

*   checking whether package ‘dataversionr’ can be installed ... ERROR
    ```
    Installation failed.
    See ‘/tmp/workdir/dataversionr/new/dataversionr.Rcheck/00install.out’ for details.
    ```
...
```
* installing *source* package ‘dataversionr’ ...
** package ‘dataversionr’ successfully unpacked and MD5 sums checked
** using staged installation
** R
** inst
...
Execution halted
ERROR: lazy loading failed for package ‘dataversionr’
* removing ‘/tmp/workdir/dataversionr/new/dataversionr.Rcheck/dataversionr’
...
Execution halted
ERROR: lazy loading failed for package ‘dataversionr’
* removing ‘/tmp/workdir/dataversionr/old/dataversionr.Rcheck/dataversionr’
...
```
* using log directory ‘/tmp/workdir/easyalluvial/new/easyalluvial.Rcheck’
* using R version 4.1.1 (2021-08-10)
* using platform: x86_64-pc-linux-gnu (64-bit)
* using session charset: UTF-8
* using option ‘--no-manual’
* checking for file ‘easyalluvial/DESCRIPTION’ ... OK
* this is package ‘easyalluvial’ version ‘0.3.1’
* package encoding: UTF-8
* checking package namespace information ... OK
* checking package dependencies ... ERROR
Package required but not available: ‘ggalluvial’

Packages suggested but not available for checking: 'workflows', 'parsnip'
...
* checking whether package ‘ggPMX’ can be installed ... ERROR
Installation failed.
See ‘/tmp/workdir/ggPMX/new/ggPMX.Rcheck/00install.out’ for details.
* DONE
...
* checking whether package ‘ggPMX’ can be installed ... ERROR
Installation failed.
See ‘/tmp/workdir/ggPMX/old/ggPMX.Rcheck/00install.out’ for details.
* DONE
Status: 1 ERROR, 1 NOTE
