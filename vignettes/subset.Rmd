...
This vignette is an attempt to provide a comprehensive overview over all subsetting operations, highlighting where the tibble implementation differs from the data frame implementation.
