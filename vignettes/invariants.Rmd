...
If the same column is updated/removed several times, the last update wins.
...
Note that `is.list(a)` is `TRUE`, but `inherits(a, "list")` is `FALSE`, then `a` is considered to be a scalar.
