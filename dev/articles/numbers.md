...
The new [`num()`](https://tibble.tidyverse.org/dev/reference/num.md)
...
[`?num`](https://tibble.tidyverse.org/dev/reference/num.md) for a
comprehensive overview. Similarly,
[`char()`](https://tibble.tidyverse.org/dev/reference/char.md) allows
...
the application,
[`num()`](https://tibble.tidyverse.org/dev/reference/num.md) or
[`char()`](https://tibble.tidyverse.org/dev/reference/char.md) allow
...
[`num()`](https://tibble.tidyverse.org/dev/reference/num.md), the result
...
[`num()`](https://tibble.tidyverse.org/dev/reference/num.md) can be
...
[`num()`](https://tibble.tidyverse.org/dev/reference/num.md) to the
result:
