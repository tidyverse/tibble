...
- [`tibble-package`](https://tibble.tidyverse.org/dev/reference/tibble-package.md)
...
- [`tbl_df-class`](https://tibble.tidyverse.org/dev/reference/tbl_df-class.md)
...
- [`char()`](https://tibble.tidyverse.org/dev/reference/char.md)
...
- [`reexports`](https://tibble.tidyverse.org/dev/reference/reexports.md)
  [`glimpse`](https://tibble.tidyverse.org/dev/reference/reexports.md)
  [`has_name`](https://tibble.tidyverse.org/dev/reference/reexports.md)
  [`%>%`](https://tibble.tidyverse.org/dev/reference/reexports.md)
  [`tbl_sum`](https://tibble.tidyverse.org/dev/reference/reexports.md)
  [`obj_sum`](https://tibble.tidyverse.org/dev/reference/reexports.md)
  [`type_sum`](https://tibble.tidyverse.org/dev/reference/reexports.md)
  [`size_sum`](https://tibble.tidyverse.org/dev/reference/reexports.md)
...
- [`enframe()`](https://tibble.tidyverse.org/dev/reference/enframe.md)
  [`deframe()`](https://tibble.tidyverse.org/dev/reference/enframe.md) :
  Converting vectors to data frames, and vice versa
- [`lst()`](https://tibble.tidyverse.org/dev/reference/lst.md) : Build a
  list
- [`as_tibble()`](https://tibble.tidyverse.org/dev/reference/as_tibble.md)
  [`as_tibble_row()`](https://tibble.tidyverse.org/dev/reference/as_tibble.md)
  [`as_tibble_col()`](https://tibble.tidyverse.org/dev/reference/as_tibble.md)
