...
- The returned data frame has the class
  ...
  in addition to `data.frame`. This allows so-called "tibbles" to
  exhibit some special behaviour, such as [enhanced
  printing](https://tibble.tidyverse.org/dev/reference/formatting.md).
...
[`tbl_df`](https://tibble.tidyverse.org/dev/reference/tbl_df-class.md).
A [`tbl_df`](https://tibble.tidyverse.org/dev/reference/tbl_df-class.md)
...
[`enframe()`](https://tibble.tidyverse.org/dev/reference/enframe.md) to
