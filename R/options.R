...
get_n_print <- function(n, rows) {
  ...
  if (is.na(rows) || rows > get_tibble_option_print_max()) {
    get_tibble_option_print_min()
  } else {
    rows
  }
}
...
get_max_extra_cols <- function(max_extra_cols) {
  ...
  get_tibble_option_max_extra_cols()
}
...
get_max_footer_lines <- function(max_footer_lines) {
  ...
  get_tibble_option_max_footer_lines()
}
