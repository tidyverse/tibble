# Getting help with tibble

Thanks for using tibble! Before filing an issue, there are a few places
...
- If it’s a bug: you’re in the right place, [file an
  issue](https://github.com/batpigandme/tibble/issues/new).
...
requests](https://github.com/batpigandme/tibble/issues) to make sure the
